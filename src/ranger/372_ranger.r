...
PARAM$ranger <- list(
  "num.trees" = 378,# 800,#300, # cantidad de arboles
  "mtry" = 8,# 12,##13, # cantidad de atributos que participan en cada split
  "min.node.size" = 530, # 50, # tamaño minimo de las hojas
  "max.depth" = 18,# 14 # 0 significa profundidad infinita
)

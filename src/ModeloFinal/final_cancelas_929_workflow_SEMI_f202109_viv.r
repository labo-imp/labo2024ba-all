...
DT_incorporar_dataset_competencia2024 <- function()
{
  ...
  param_local$meta$script <- "/src/ModeloFinal/wf-etapas/z1101_DT_incorporar_dataset.r"
...
CA_catastrophe_base <- function( pinputexps, metodo )
{
  ...
  param_local$meta$script <- "/src/ModeloFinal/wf-etapas/z1201_CA_reparar_dataset.r"
...
FEintra_manual_base <- function( pinputexps )
{
  ...
  param_local$meta$script <- "/src/ModeloFinal/wf-etapas/1301_FE_intrames_manual_modeloFinal.r"
...
DR_drifting_base <- function( pinputexps, metodo)
{
  ...
  param_local$meta$script <- "/src/ModeloFinal/wf-etapas/z1401_DR_corregir_drifting.r"
...
FEhist_base <- function( pinputexps)
{
  ...
  param_local$meta$script <- "/src/ModeloFinal/wf-etapas/z1501_FE_historia.r"
...
FErf_attributes_base <- function( pinputexps, ratio, desvio)
{
  ...
  param_local$meta$script <- "/src/ModeloFinal/wf-etapas/z1311_FE_rfatributes.r"
...
CN_canaritos_asesinos_base <- function( pinputexps, ratio, desvio)
{
  ...
  param_local$meta$script <- "/src/ModeloFinal/wf-etapas/z1601_CN_canaritos_asesinos.r"
...
TS_strategy_base9 <- function( pinputexps )
{
  ...
  param_local$meta$script <- "/src/ModeloFinal/wf-etapas/z2101_TS_training_strategy.r"
...
HT_tuning_semillerio <- function( pinputexps, semillerio, bo_iteraciones, bypass=FALSE)
{
  ...
  param_local$meta$script <- "/src/ModeloFinal/wf-etapas/z2213_HT_lightgbm_SEMI.r"
...
FM_final_models_lightgbm_semillerio <- function( pinputexps, ranks, semillerio, repeticiones_exp)
{
  ...
  param_local$meta$script <- "/src/ModeloFinal/wf-etapas/z2302_FM_final_models_lightgbm_SEMI.r"
...
SC_scoring_semillerio <- function( pinputexps )
{
  ...
  param_local$meta$script <- "/src/ModeloFinal/wf-etapas/z2402_SC_scoring_lightgbm_SEMI.r"
...
KA_evaluate_kaggle_semillerio <- function( pinputexps )
{
  ...
  param_local$meta$script <- "/src/ModeloFinal/wf-etapas/z2602_KA_evaluate_kaggle_SEMI.r"

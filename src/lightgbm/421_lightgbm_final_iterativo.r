...
PARAM$finalmodel$num_iterations <- 1091
PARAM$finalmodel$learning_rate <- 0.023652
PARAM$finalmodel$feature_fraction <- 0.91361918
PARAM$finalmodel$min_data_in_leaf <- 762
PARAM$finalmodel$num_leaves <- 686

PARAM$finalmodel$max_bin <- 31
PARAM$finalmodel$lambda_l1 <- 0.844529
PARAM$finalmodel$lambda_l2 <- 0.7570364
PARAM$finalmodel$max_depth <- 0.9814

PARAM$finalmodel$min_split_gain <- 0.027885
PARAM$finalmodel$bagging_fraction <- 6

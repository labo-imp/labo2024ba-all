...
PARAM$finalmodel$num_iterations <- 233
PARAM$finalmodel$learning_rate <- 0.06933736539
PARAM$finalmodel$feature_fraction <- 0.5489993766
PARAM$finalmodel$min_data_in_leaf <- 2092
PARAM$finalmodel$num_leaves <- 504
PARAM$finalmodel$max_bin <- 40 # este tambien cambie de 31 a 44

PARAM$finalmodel$lambda_l1 <- 0.008541897823
PARAM$finalmodel$lambda_l2 <- 0.563732307
PARAM$finalmodel$min_gain_to_split <- 0.1964624134
PARAM$finalmodel$max_depth <- 14
PARAM$finalmodel$bagging_fraction <- 0.9497056892

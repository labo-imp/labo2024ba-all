...
PARAM$finalmodel$num_iterations <- 849
PARAM$finalmodel$learning_rate <- 0.01263
PARAM$finalmodel$feature_fraction <- 0.8483
PARAM$finalmodel$min_data_in_leaf <- 915
PARAM$finalmodel$num_leaves <- 975

PARAM$finalmodel$max_bin <- 31
PARAM$finalmodel$lambda_l1 <- 0.066142
PARAM$finalmodel$lambda_l2 <- 0.279694
PARAM$finalmodel$max_depth <- 0.88374755

PARAM$finalmodel$min_split_gain <- 0.0117903
PARAM$finalmodel$bagging_fraction <- 5

...
PARAM$finalmodel$num_iterations <- 229
PARAM$finalmodel$learning_rate <- 0.053178
PARAM$finalmodel$feature_fraction <- 0.466850
PARAM$finalmodel$min_data_in_leaf <- 3408
PARAM$finalmodel$num_leaves <- 694
PARAM$finalmodel$lambda_l1 <- 401020553739824
PARAM$finalmodel$lambda_l2 <- 349754341889523
PARAM$finalmodel$min_gain_to_split <- 0.117898
PARAM$finalmodel$max_depth <- 13
PARAM$finalmodel$num_iterations <- 229
PARAM$finalmodel$envios <- 5001
PARAM$finalmodel$bagging_fraction <- 0.803974

...
PARAM$finalmodel$num_iterations <- 320
PARAM$finalmodel$learning_rate <- 0.011218
PARAM$finalmodel$feature_fraction <- 0.99202
PARAM$finalmodel$min_data_in_leaf <- 1100

...
hs <- makeParamSet(
  ...
  makeIntegerParam("envios", lower = 1000L, upper = 6000L), 
  
  #desde aca para abajo, los que agregue yo: 
  makeNumericParam("lambda_l1", lower = 0, upper = 1),
  makeNumericParam("lambda_l2", lower = 0, upper = 1),
  makeNumericParam("min_gain_to_split", lower = 0, upper = 0.2),
  makeIntegerParam("max_bin", lower = 10L, upper = 50L), 

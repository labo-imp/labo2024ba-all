...
hs <- makeParamSet(
  makeNumericParam("learning_rate", lower = 0.2, upper = 0.8),
  makeIntegerParam("num_leaves", lower = 8L, upper = 1024L),
  makeNumericParam("feature_fraction", lower = 0.1, upper = 1.0),
  makeIntegerParam("min_data_in_leaf", lower = 1L, upper = 500L),
  makeNumericParam("envios", lower = 10L, upper = 3000L),
  makeNumericParam("lambda_l1", lower = 1L, upper = 450L),
  makeIntegerParam("lambda_l2", lower = 1L, upper = 450L),
  makeNumericParam("bagging_fraction", lower = 0.01, upper = 1L),

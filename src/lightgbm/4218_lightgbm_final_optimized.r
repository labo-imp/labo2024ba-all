...
PARAM$experimento <- paste0("KA4218-",fdate,"-",ftime)

PARAM$input$training <- c(202107) # meses donde se entrena el modelo
PARAM$input$future <- c(202109) # meses donde se aplica el modelo


PARAM$finalmodel$num_iterations <- 213
PARAM$finalmodel$learning_rate <- 0.2
PARAM$finalmodel$feature_fraction <- 0.82
PARAM$finalmodel$min_data_in_leaf <- 161
PARAM$finalmodel$num_leaves <- 144
PARAM$finalmodel$max_bin <- 1899

#parametros extra
PARAM$finalmodel$objective <- "binary"
PARAM$finalmodel$metric <- "custom"
PARAM$finalmodel$lambda_l1 <- 29.88
PARAM$finalmodel$lambda_l2 <- 71.76
PARAM$finalmodel$bagging_fraction <- 0.56
PARAM$finalmodel$min_gain_to_split <- 0.033

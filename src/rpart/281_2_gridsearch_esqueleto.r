...
star_time <- Sys.time() # noto tiempo de inicio del proceso

PARAM <- list()
# reemplazar por su primer semilla
PARAM$semilla_primigenia <- 737179
PARAM$qsemillas <- 10
...
for (vmax_depth in c(6, 8)) {
  for (vmin_split in c(800, 750, 700, 600, 650, 600, 550, 500, 450, 400)) {
    for (vmin_bucket in c(400, 350, 300, 250, 200)) {
...
# noto hora de finalizacion y calculo tiempo total del proceso

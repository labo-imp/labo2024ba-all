...
TS_strategy_base9 <- function( pinputexps )
{
  ...
  param_local$final_train$training <- c(    202106,202105, 202104,  202103 , 202102, 202101, 202012 , 202011, 202010 , 202009 , 202008 , 
  ...
  param_local$train$training <- c(      202103 , 202102, 202101, 202012 , 202011, 202010 , 202009 , 202008 , 202007 , 
                                        202005   , 202004 , 202003 , 202002 , 202001 ,  201912 , 201911 ,  201910 , 201909  )

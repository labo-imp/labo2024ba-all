...
#Es una modificación del prueba12: Quitado Lag2, cambiado semillerio para quedarme con los 2 mejores hiperparametros en lugar de primeros 2 y experimentos=2.

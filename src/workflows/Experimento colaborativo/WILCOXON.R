...
#Como me da que las diferencias no son significativas en ningun caso, en terminos de ganancias me da lo mismo pero 
#computacionalmente el de 13 hip me cuesta mucho mas
...
envio1600_base<-c(5319,4089.,7239,4639,3839,4639,4259,6369,4999,3709,4449,5169,6459,4849,5779,4779,3549,4329,5499,5149)
envio1700_base<-c(5339,4989,7009,5149,3489,4299,4399,6889,6249,4229,4179,5299,6549,4989,5499,4539,3249,3979,5219,4859)
envio1800_base<-c(5469,4739,6709,5309,3589,3989,4429,6609,5949,4269,4339,5029,6689,5019,5619,4149,3659,4119,5299,4569)
envio1900_base<-c(5969,4419,6879,5439,3309,3679,4499,6739,5679,4019,4069,4709,6339,4729,5279,4239,3809,4189,5399,4279)
envio2000_base<-c(6439,4199,6929,5499,4209,4249,4089.,6729,5379,4539,3719,4489,6409,4779,6199,4359,3559,4659,5089,3969)
envio2100_base<-c(6059,3819,6629,5199,4339,4759,4949,6419,5539,4229,3879,4139,6099,4569,5989,4079.,4029,4439,5229,4059)
envio2200_base<-c(5729,3989,6349,4899,4449,4529,4669,6149,5319,4339,3999,4269,5759,4659,5739,4189,4499,4129,5349,4959)

# Lista para almacenar los p-valores
resultados_pvalores <- data.frame(Comparacion = character(), PValor = numeric(), stringsAsFactors = FALSE)
# Supongamos que ya tienes las filas de tus envíos (por ejemplo, envio1600, envio1700, etc.)
envios <- list(envio2000,envio1600_base, envio1700_base, envio1800_base, envio1900_base, envio2000_base, envio2100_base, envio2200_base)
names(envios) <- c("2000_6hip","1600", "1700", "1800", "1900", "2000", "2100", "2200")

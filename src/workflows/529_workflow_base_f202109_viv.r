...
CN_canaritos_asesinos_base_3 <- function( pinputexps, ratio, desvio)
{
  if( -1 == (param_local <- exp_init())$resultado ) return( 0 )# linea fija
  ...
  param_local$train$clase01_valor1 <- c( "BAJA+2", "BAJA+1")
  param_local$train$positivos <- c( "BAJA+2")
  param_local$train$training <- c(202001, 202002, 202003, 202004, 202005, 202006, 202007, 202008, 202009, 202010, 202011, 202012, 202101, 202102, 202103)
  param_local$train$validation <- c( 202105 )
  param_local$train$undersampling <- 0.1
  param_local$train$gan1 <- 117000
  param_local$train$gan0 <-  -3000
...
wf_septiembre <- function( pnombrewf )
{
  ...
  CN_canaritos_asesinos_base_3(ratio=0.95, desvio=2.35) # Incluye desde la pandemia hasta la fecha del CN base
  #FEhist_base_2()
  #FErf_attributes_base()

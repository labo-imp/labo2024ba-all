...
# Es prueba 13 cambiando CN a parametros mas usados y semillio solo al mejor. Prueba 3 es prueba 6 arreglado bug de semillerio , quedandome con 2 mejoresw y 2 experimentos
...
wf_SEMI_sep <- function( pnombrewf )
{
  ...
  CA_catastrophe_base( metodo="Ninguno") # Probar luego si funciona Ninguno.
  FEintra_manual_base()
